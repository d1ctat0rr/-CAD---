...
void initapp()
{
	...
	acedRegCmds->addCommand(cmd_group_name, _T("creatMineClearance"), _T("creatMineClearance"), ACRX_CMD_MODAL, creatMineClearance);



	CMineClearance::rxInit();//注册自定义实体
...
void unloadapp()
{
	...
	deleteAcRxClass(CMineClearance::desc());//注销自定义实体
}
